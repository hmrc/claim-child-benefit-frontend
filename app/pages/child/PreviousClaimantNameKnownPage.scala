...
final case class PreviousClaimantNameKnownPage(index: Index) extends ChildQuestionPage[Boolean] {

  override def path: JsPath = JsPath \ "children" \ index.position \ toString

  override def toString: String = "previousClaimantNameKnown"

  override def route(waypoints: Waypoints): Call =
    routes.PreviousClaimantNameKnownController.onPageLoad(waypoints, index)
