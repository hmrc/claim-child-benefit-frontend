...
final case class PreviousGuardianInternationalAddressPage(index: Index) extends ChildQuestionPage[InternationalAddress] {

  override def path: JsPath = JsPath \ "children" \ index.position \ toString

  override def toString: String = "previousGuardianInternationalAddress"
