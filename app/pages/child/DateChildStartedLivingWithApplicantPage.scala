...
final case class DateChildStartedLivingWithApplicantPage(index: Index) extends ChildQuestionPage[LocalDate] {

  override def path: JsPath = JsPath \ "children" \ index.position \ toString

  override def toString: String = "dateChildStartedLivingWithApplicant"
