...
case object ApplicantPreviousInternationalAddressPage extends QuestionPage[InternationalAddress] {

  override def path: JsPath = JsPath \ toString

  override def toString: String = "applicantPreviousInternationalAddress"
