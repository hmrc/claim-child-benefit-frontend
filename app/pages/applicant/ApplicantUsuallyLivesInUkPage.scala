...
case object ApplicantUsuallyLivesInUkPage extends QuestionPage[Boolean] {

  override def path: JsPath = JsPath \ toString

  override def toString: String = "applicantUsuallyLivesInUk"

  override def route(waypoints: Waypoints): Call =
    routes.ApplicantUsuallyLivesInUkController.onPageLoad(waypoints)
