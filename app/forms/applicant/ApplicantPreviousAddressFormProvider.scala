...
class ApplicantPreviousAddressFormProvider @Inject() extends Mappings {
   ...
   def apply(): Form[Address] = Form(
     mapping(
       ...
       "town" -> text("applicantPreviousAddress.error.town.required")
         .verifying(maxLength(100, "applicantPreviousAddress.error.town.length")),
       "county" -> optional(text("applicantPreviousAddress.error.county.required")
         .verifying(maxLength(100, "applicantPreviousAddress.error.county.length"))),
