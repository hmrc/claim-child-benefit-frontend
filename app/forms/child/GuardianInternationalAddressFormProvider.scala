    ...
    mapping(
      "line1" -> text("guardianInternationalAddress.error.line1.required", args = Seq(guardian.firstName))
        .verifying(firstError(
          ...
          regexp(Validation.safeInputPattern, "guardianInternationalAddress.error.line1.invalid", guardian.firstName)
        )),
      "line2" -> optional(text("guardianInternationalAddress.error.line2.required", args = Seq(guardian.firstName))
        .verifying(firstError(
          ...
          regexp(Validation.safeInputPattern, "guardianInternationalAddress.error.line2.invalid", guardian.firstName)
        ))),
      "town" -> text("guardianInternationalAddress.error.town.required", args = Seq(guardian.firstName))
        .verifying(firstError(
          ...
          regexp(Validation.safeInputPattern, "guardianInternationalAddress.error.town.invalid", guardian.firstName)
        )),
      "state" -> optional(text("guardianInternationalAddress.error.state.required", args = Seq(guardian.firstName))
        .verifying(firstError(
          ...
          regexp(Validation.safeInputPattern, "guardianInternationalAddress.error.state.invalid", guardian.firstName)
        ))),
      "postcode" -> optional(text("guardianInternationalAddress.error.postcode.required", args = Seq(guardian.firstName))
        .verifying(firstError(
          ...
          regexp(Validation.safeInputPattern, "guardianInternationalAddress.error.postcode.invalid", guardian.firstName)
        ))),
