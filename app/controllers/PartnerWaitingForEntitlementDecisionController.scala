...
import pages.{PartnerNamePage, PartnerWaitingForEntitlementDecisionPage, Waypoints}
        ...
        partnerName =>
          ...
          form.bindFromRequest().fold(
            ...
            value =>
              ...
              } yield Redirect(PartnerWaitingForEntitlementDecisionPage.navigate(waypoints, updatedAnswers))
          )
      }
  }
}