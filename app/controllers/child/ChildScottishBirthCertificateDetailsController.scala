...
class ChildScottishBirthCertificateDetailsController @Inject()(
        ...
        childName =>
          ...
          form.bindFromRequest().fold(
            ...
            value =>
              ...
              } yield Redirect(ChildScottishBirthCertificateDetailsPage(index).navigate(waypoints, request.userAnswers, updatedAnswers).route)
          )
      }
  }
}