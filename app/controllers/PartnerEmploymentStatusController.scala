...
import pages.{PartnerEmploymentStatusPage, PartnerNamePage, Waypoints}
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import play.twirl.api.HtmlFormat
import repositories.SessionRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.PartnerEmploymentStatusView

import scala.concurrent.{ExecutionContext, Future}

class PartnerEmploymentStatusController @Inject()(
                                        override val messagesApi: MessagesApi,
                                        sessionRepository: SessionRepository,
                                        identify: IdentifierAction,
                                        getData: DataRetrievalAction,
                                        requireData: DataRequiredAction,
                                        formProvider: PartnerEmploymentStatusFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: PartnerEmploymentStatusView
    ...
    implicit request =>
      getAnswer(PartnerNamePage) {
        partnerName =>
          ...
          val preparedForm = request.userAnswers.get(PartnerEmploymentStatusPage) match {
            case None => form
        ...
        partnerName =>
          ...
          form.bindFromRequest().fold(
            ...
            value =>
              ...
              } yield Redirect(PartnerEmploymentStatusPage.navigate(waypoints, updatedAnswers))
          )
      }
  }
}