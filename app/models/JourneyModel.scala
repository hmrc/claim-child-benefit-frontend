...
object JourneyModel {
  ...
  object Residency {
    ...
    final case class LivedInUkAndAbroad(usualCountryOfResidence: Option[Country], arrivalDate: Option[LocalDate], countriesWorked: List[Country], countriesReceivedBenefits: List[Country]) extends Residency
    final case class AlwaysLivedAbroad(usualCountryOfResidence: Country, countriesWorked: List[Country], countriesReceivedBenefits: List[Country]) extends Residency
  }
