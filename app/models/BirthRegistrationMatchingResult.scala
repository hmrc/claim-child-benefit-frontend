...
sealed trait BirthRegistrationMatchingResult

object BirthRegistrationMatchingResult extends Enumerable.Implicits {
  ...
  val values: Seq[BirthRegistrationMatchingResult] = Seq(
    Matched, NotMatched, NotAttempted, MatchingAttemptFailed
  )
