    ...
    "must call the audit connector with the correct payload" in {
      ...
      val model = JourneyModel(
        applicant = JourneyModel.Applicant(
          ...
          employmentStatus = Set(models.ApplicantEmploymentStatus.Employed, models.ApplicantEmploymentStatus.SelfEmployed)
        ),
        ...
        children = NonEmptyList(
          JourneyModel.Child(
            ...
            birtCertificateSystemNumber = Some("000000000"),
        ...
        paymentPreference = JourneyModel.PaymentPreference.ExistingFrequency(
          bankAccountDetails = Some(models.BankAccountDetails("account name", "000000", "00000000", Some("roll number"))),
      ...
      val expectedAuditEvent: DownloadAuditEvent = DownloadAuditEvent(
        ...
        paymentPreference = ExistingFrequency(
          bankAccountDetails = Some(BankAccountDetails("account name", "000000", "00000000", Some("roll number"))),
