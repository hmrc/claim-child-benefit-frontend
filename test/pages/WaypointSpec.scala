...
class WaypointSpec extends AnyFreeSpec with Matchers with OptionValues {
  ...
  ".fromString" - {
    ...
    "must return Add Country Applicant Worked when given its check mode waypoint" in {
      ...
      Waypoint.fromString("change-country-you-worked").value `mustEqual` AddCountryApplicantWorkedPage().waypoint(
        CheckMode
      )
    }
    ...
    "must return Add Country Applicant Received Benefits when given its Normal mode waypoint" in {
      ...
      Waypoint.fromString("add-country-you-received-benefits").value `mustEqual` AddCountryApplicantReceivedBenefitsPage()
        .waypoint(NormalMode)
    }
    ...
    "must return Add Country Applicant Received Benefits when given its check mode waypoint" in {
      ...
      Waypoint
        .fromString("change-country-you-received-benefits")
        .value `mustEqual` AddCountryApplicantReceivedBenefitsPage().waypoint(CheckMode)
    }
    ...
    "must return Add Country Partner Worked when given its Normal mode waypoint" in {
      ...
      Waypoint.fromString("add-country-your-partner-worked").value `mustEqual` AddCountryPartnerWorkedPage().waypoint(
        NormalMode
      )
    }
    ...
    "must return Add Country Partner Worked when given its check mode waypoint" in {
      ...
      Waypoint.fromString("change-country-your-partner-worked").value `mustEqual` AddCountryPartnerWorkedPage().waypoint(
        CheckMode
      )
    }
    ...
    "must return Add Country Partner Received Benefits when given its Normal mode waypoint" in {
      ...
      Waypoint
        .fromString("add-country-your-partner-received-benefits")
        .value `mustEqual` AddCountryPartnerReceivedBenefitsPage().waypoint(NormalMode)
    }

    "must return Add Country Partner Received Benefits when given its check mode waypoint" in {

      Waypoint
        .fromString("change-country-your-partner-received-benefits")
        .value `mustEqual` AddCountryPartnerReceivedBenefitsPage().waypoint(CheckMode)
    }
