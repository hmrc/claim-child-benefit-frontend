...
class PartnerNinoFormProviderSpec extends StringFieldBehaviours {

  val name = "name"
  val requiredKey = "partnerNino.error.required"
  val lengthKey = "partnerNino.error.length"
  val maxLength = 100

  val form = new PartnerNinoFormProvider()(name)
