...
class PreviousGuardianAddressKnownFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "previousGuardianAddressKnown.error.required"
  val invalidKey = "error.boolean"

  private val previousGuardian = AdultName(None, "first", None, "last")
  val form = new PreviousGuardianAddressKnownFormProvider()(previousGuardian)
