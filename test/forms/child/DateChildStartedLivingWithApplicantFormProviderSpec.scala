...
class DateChildStartedLivingWithApplicantFormProviderSpec extends DateBehaviours {
  ...
  val form = new DateChildStartedLivingWithApplicantFormProvider(clock)(childName)
