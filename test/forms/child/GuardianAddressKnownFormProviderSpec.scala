...
class GuardianAddressKnownFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "guardianAddressKnown.error.required"
  val invalidKey = "error.boolean"

  private val previousGuardian = AdultName(None, "first", None, "last")
  val form = new GuardianAddressKnownFormProvider()(previousGuardian)
