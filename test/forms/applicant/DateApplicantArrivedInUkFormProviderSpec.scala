...
class DateApplicantArrivedInUkFormProviderSpec extends DateBehaviours {
  ...
  private val form = new DateApplicantArrivedInUkFormProvider(clock)()
  ...
  ".value" - {
    ...
    behave like dateFieldWithMax(
      ...
      key       = "value",
      max       = maxDate,
      formError = FormError("value", "dateApplicantArrivedInUk.error.afterMaximum", Seq(maxDate.format(dateFormatter)))
    )

    behave like mandatoryDateField(form, "value", "dateApplicantArrivedInUk.error.required.all")
  }
}
