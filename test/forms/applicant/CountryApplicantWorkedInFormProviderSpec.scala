...
class CountryApplicantWorkedInFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "countryApplicantWorkedIn.error.required"
  val invalidKey = "countryApplicantWorkedIn.error.invalid"

  val form = new CountryApplicantWorkedInFormProvider()()
