...
class BankAccountDetailsSpec extends AnyFreeSpec with Matchers {
  ...
  ".sortCodeTrimmed" - {
    ...
    "must remove spaces and dashes from the sort code" in {
      ...
      val details1 = BankAccountDetails("first", "last", "bank name", "12 34 56", "00123456", None)
      val details2 = BankAccountDetails("first", "last", "bank name", "12-34-56", "00123456", None)
  ...
  ".accountNumberPadded" - {
    ...
    "must left-pad the account number with zeros" in {
      ...
      val details1 = BankAccountDetails("first", "last", "bank name", "123456", "123456", None)
      val details2 = BankAccountDetails("first", "last", "bank name", "123456", "1234567", None)
