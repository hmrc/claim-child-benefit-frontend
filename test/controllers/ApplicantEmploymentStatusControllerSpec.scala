...
import pages.{ApplicantEmploymentStatusPage, EmptyWaypoints}
  ...
  "ApplicantEmploymentStatus Controller" - {
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual ApplicantEmploymentStatusPage.navigate(waypoints, expectedAnswers).url
