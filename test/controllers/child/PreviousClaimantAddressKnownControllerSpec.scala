...
class PreviousClaimantAddressKnownControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val previousClaimantAddressKnownRoute = routes.PreviousClaimantAddressKnownController.onPageLoad(waypoints, index).url
  ...
  "PreviousClaimantAddressKnown Controller" - {
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual child.PreviousClaimantAddressKnownPage(index).navigate(waypoints, emptyUserAnswers, expectedAnswers).url
