...
class ChildNameChangedByDeedPollControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val childNameChangedByDeedPollRoute =
    routes.ChildNameChangedByDeedPollController.onPageLoad(waypoints, index).url
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value `mustEqual` child
          .ChildNameChangedByDeedPollPage(index)
