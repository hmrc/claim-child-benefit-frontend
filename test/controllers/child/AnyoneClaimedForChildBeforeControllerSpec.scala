...
class AnyoneClaimedForChildBeforeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val anyoneClaimedForChildBeforeRoute =
    routes.AnyoneClaimedForChildBeforeController.onPageLoad(waypoints, index).url
  ...
  "AnyoneClaimedForChildBefore Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseAnswers.set(AnyoneClaimedForChildBeforePage(index), true).success.value
