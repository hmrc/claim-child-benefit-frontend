...
import models.{ChildBiologicalSex, UserAnswers}
  ...
  "ChildBiologicalSex Controller" - {
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val result = route(application, request).value
        val expectedAnswers = emptyUserAnswers.set(child.ChildBiologicalSexPage(index), ChildBiologicalSex.values.head).success.value
