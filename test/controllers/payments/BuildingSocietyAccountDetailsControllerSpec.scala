...
import forms.payments.BuildingSocietyAccountDetailsFormProvider
import models.BuildingSocietyAccountDetails
import org.mockito.ArgumentMatchers.{any, eq => eqTo}
import org.mockito.Mockito.{times, verify, when}
import org.scalatestplus.mockito.MockitoSugar
import pages.EmptyWaypoints
import pages.payments.BuildingSocietyAccountDetailsPage
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.payments.BuildingSocietyAccountDetailsView

import scala.concurrent.Future

class BuildingSocietyAccountDetailsControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new BuildingSocietyAccountDetailsFormProvider()
  ...
  "BuildingSocietyAccountDetails Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, buildingSocietyAccountDetailsRoute)

        val view = application.injector.instanceOf[BuildingSocietyAccountDetailsView]
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual BuildingSocietyAccountDetailsPage.navigate(waypoints, expectedAnswers).url
