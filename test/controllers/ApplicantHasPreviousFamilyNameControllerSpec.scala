...
import forms.ApplicantHasPreviousFamilyNameFormProvider
import models.UserAnswers
import org.mockito.ArgumentMatchers.{any, eq => eqTo}
import org.mockito.Mockito.{times, verify, when}
import org.scalatestplus.mockito.MockitoSugar
import pages.{ApplicantHasPreviousFamilyNamePage, EmptyWaypoints}
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.ApplicantHasPreviousFamilyNameView
...
class ApplicantHasPreviousFamilyNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  "ApplicantHasPreviousFamilyName Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, applicantHasPreviousFamilyNameRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ApplicantHasPreviousFamilyNamePage, true).success.value
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, applicantHasPreviousFamilyNameRoute)
        ...
        redirectLocation(result).value mustEqual ApplicantHasPreviousFamilyNamePage.navigate(waypoints, expectedAnswers).url
