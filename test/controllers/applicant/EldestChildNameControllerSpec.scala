...
class EldestChildNameControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new EldestChildNameFormProvider()
  ...
  "EldestChildName Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, eldestChildNameRoute)

        val view = application.injector.instanceOf[EldestChildNameView]
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual EldestChildNamePage.navigate(waypoints, emptyUserAnswers, expectedAnswers).url
