  ...
  "AddApplicantNationality Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val nationalities =
          AddApplicantNationalitySummary.rows(emptyUserAnswers, waypoints, AddApplicantNationalityPage())
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value `mustEqual` AddApplicantNationalityPage()
