...
class ApplicantCurrentInternationalAddressControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new ApplicantCurrentInternationalAddressFormProvider()
  ...
  "ApplicantCurrentAddress Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, applicantCurrentInternationalAddressRoute)

        val view = application.injector.instanceOf[ApplicantCurrentInternationalAddressView]
