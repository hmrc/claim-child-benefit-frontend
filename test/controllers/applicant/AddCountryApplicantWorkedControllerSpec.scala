...
class AddCountryApplicantWorkedControllerSpec extends SpecBase with MockitoSugar {

  private val formProvider = new AddCountryApplicantWorkedFormProvider()
  private val form = formProvider()
  private val waypoints = EmptyWaypoints

  private lazy val addCountryApplicantWorkedRoute = routes.AddCountryApplicantWorkedController.onPageLoad(waypoints).url

  "AddCountryApplicantWorked Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, addCountryApplicantWorkedRoute)
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, addCountryApplicantWorkedRoute)
