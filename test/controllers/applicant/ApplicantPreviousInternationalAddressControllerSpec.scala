...
import models.{Country, Done, InternationalAddress, UkAddress}
...
class ApplicantPreviousInternationalAddressControllerSpec extends SpecBase with MockitoSugar with ModelGenerators {
  ...
  lazy val applicantPreviousInternationalAddressRoute =
    routes.ApplicantPreviousInternationalAddressController.onPageLoad(waypoints).url
  ...
  "ApplicantPreviousAddress Controller" - {
    ...
    "must save the answer and redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value `mustEqual` ApplicantPreviousInternationalAddressPage
