...
class AdditionalInfoSectionJourneySpec extends AnyFreeSpec with JourneyHelpers {
  ...
  "users must proceed from Additional Information to the task list" in {

    startingFrom(AdditionalInformationPage)
      .run(
        submitAnswer(AdditionalInformationPage, Information("foo")),
